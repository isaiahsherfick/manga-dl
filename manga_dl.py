...
print("Initializing webcrawler object to crawl https://www.mangadex.org")
crawler = webcrawler.MyWebCrawler("https://mangadex.org/title/6272/jojo-s-bizarre-adventure-part-7-steel-ball-run-official-colored",1)

#populates crawler.chapters
crawler.crawl()
crawler.sortChapters()
